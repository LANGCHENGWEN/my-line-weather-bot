...
一個貼心的天氣預報 LINE Bot，陪你一起關心每一天的天氣。

結合氣象資料與自動化推播系統，讓使用者即時掌握天氣變化，輕鬆規劃每日生活。

整合即時天氣、未來預報、颱風資訊，並提供穿搭建議、週末天氣與節氣小知識，讓天氣不只是數據，而是更貼近你的日常。

支援城市切換與自動推播設定，可依需求接收每日天氣、週末預報、颱風提醒與節氣知識，打造智慧又貼心的氣象體驗，讓生活更安心、出行更從容。

**命名理念**：希望在上班或出門前，透過貼心天氣提醒使用者，像朋友般溫暖陪伴，讓一天的開始更有動力。

---

## 📹 快速預覽：天氣預報 LINE Bot Demo

這支總覽影片帶你快速了解本專案的主要操作方式，包含 3 項核心功能：
...
[![LINE Bot Demo 影片預覽](https://img.youtube.com/vi/EGWtHpF9Du0/maxresdefault.jpg)](https://youtu.be/EGWtHpF9Du0?list=PL9EucZj4E33dZZ8h6zLyG_qaOrstOurs9)

📌 如需查看每個功能的詳細操作影片，請參考下方的「功能特色」區塊，每個功能皆附有對應的 Demo。
...
- 查詢 **未來預報**（提供 3 天、5 天、7 天的天氣趨勢與詳細預報）
- 查詢 **今日天氣**（體感、最低 ~ 最高溫、濕度、降雨機率、風速、舒適度、紫外線指數等資訊）

Demo：https://youtu.be/rFPrE4ckDNM
...
Demo：https://youtu.be/CL0uQpdi4N0
...
Demo：https://youtu.be/D5g_3yJKbLY
...
Demo：https://youtu.be/XxTDztdnreY
...
- `push_modules/`：每日或定時自動推播模組（每日與週末天氣、颱風速報、節氣知識）
